...
export default function NuevaFacturaProveedor({ params }: { params: { id: string } }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-4 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-medium text-gray-800">Nueva Factura de Proveedor</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Número de Factura de Proveedor</label>
              <input 
                type="text" 
                placeholder="ej. PROV-2024-123"
          ...
          {/* Subida de Factura */}
          <div className="mt-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">Adjuntar PDF de Factura</label>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h3 className="text-lg font-medium text-gray-700 mb-4">Información del Proveedor</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">ID Fiscal / CIF</label>
              <input 
                type="text" 
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Forma de Facturación</label>
            <div className="relative">
              <select className="w-full p-2 border rounded-md appearance-none">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Esta factura está relacionada con el negocio actual.</p>
            </div>
          </div>
        </div>
