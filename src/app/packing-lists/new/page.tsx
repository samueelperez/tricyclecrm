          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              ...
              <div className="mt-1 text-xs text-gray-500">
                ID: {packingList.cliente_id ? packingList.cliente_id : 'No seleccionado'}, 
                Nombre: {packingList.cliente_nombre ? packingList.cliente_nombre : 'No seleccionado'}
                {packingList.cliente_id && !packingList.cliente_nombre && (
                  <span className="text-red-500 font-medium block">
                    ⚠️ Error: ID seleccionado pero nombre no asignado. Por favor, seleccione otro cliente.
                  </span>
                )}
              </div>
            </div>
